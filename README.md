...
Pushing a matching tag such as `v2026.8.0` builds a self-contained macOS app and CLI archive for Apple Silicon, then publishes them to GitHub Releases with SHA-256 checksums. The tag, Cargo package, and app bundle versions must match.
